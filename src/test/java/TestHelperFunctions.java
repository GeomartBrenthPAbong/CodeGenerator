...
public class TestHelperFunctions {
     ...
     * Example Usage:
     ...
     TestHelperFunctions.printTokens(generatedTokens, "\n");

     System.out.println("The expected: ");
     TestHelperFunctions.printTokens(expectedTokens, "\n");
     *
     * @param p1
     * @param p2
     * @return
     */
    public static void printTokens(List<Pair<String, String>> tokens, String divider){
        System.out.println("{");
